...
const getPrice=async(d,data,type)=>{
    ...
    if (type =='product'){
        body={
            ...
            'Descuento_1':data.Descuento_1 == '' || data.Descuento_1 == "" ? null : data.Descuento_1,
            'Descuento_2':data.Descuento_2 == '' || data.Descuento_2 == "" ? null : data.Descuento_2,
            'Descuento_3':data.Descuento_3 == '' || data.Descuento_3 == "" ? null : data.Descuento_3,
            'Descuento_4':data.Descuento_4 == '' || data.Descuento_4 == "" ? null : data.Descuento_4,
            'Descuento_5':data.Descuento_5 == '' || data.Descuento_5 == "" ? null : data.Descuento_5,
            'Descuento_Inicial':data.Descuento_Inicial == '' || data.Descuento_Inicial == "" ? null : data.Descuento_Inicial,
            'Nit' : data.nit,
